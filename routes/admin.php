...
Route::get('get_user_standards', 'App\Http\Controllers\UsersController@get_user_standards');
...
Route::post('save_user_standards', 'App\Http\Controllers\UsersController@save_user_standards');
