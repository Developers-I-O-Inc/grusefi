...
class CategoriasController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($categorias)
                    ...
                    ->addColumn('buttons', function($row){
                           $btn = '<button data-id="'.$row->id.'" type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-kt-categoria-table-filter="edit">
        ...
        return view('catalogs/categorias');
     ...
     */
    public function destroy_categorias(Request $request)
    {
        $ids = $request->input('ids');
        Categorias::whereIn('id', $ids)->delete();
