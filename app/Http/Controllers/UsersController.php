        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($users)
                    ...
                    ->addColumn('buttons', function($row){
                        ...
                        <button data-id="'.$row->id.'" type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-kt-user-table-filter="reset-pass" data-bs-toggle="tooltip" title="Restaurar contraseña">
