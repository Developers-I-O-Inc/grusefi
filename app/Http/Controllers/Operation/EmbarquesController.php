...
class EmbarquesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //                    $btn = '<button data-id="'.$row->id.'" type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-kt-calibre-table-filter="edit">
        ...
        return view('operation/embarques', compact('empaques'));
