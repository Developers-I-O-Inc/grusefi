...
class Empaques extends Model
{
    ...
    public static function get_empaques_localidad($id){
       return DB::select("
        SELECT cat_empaques.id, localidad_id, localidades.municipio_id, localidad_doc_id, localidades2.municipio_id as municipio2, cat_empaques.nombre_corto, nombre_fiscal, domicilio_fiscal, num_ext,num_int,
