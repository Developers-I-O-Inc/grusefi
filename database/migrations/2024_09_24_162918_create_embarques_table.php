...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('op_embarques', function (Blueprint $table) {
            ...
            $table->smallInteger('lugar_id')->unsigned()->index()->nullable();
            $table->smallInteger('uso_id')->unsigned()->index()->nullable();
            ...
            $table->enum('status', ['Pendiente', 'Modificado', 'Finalizado', 'Cancelado'])->default('Pendiente');
