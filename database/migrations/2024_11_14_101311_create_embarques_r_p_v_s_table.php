...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('op_embarques_rpv', function (Blueprint $table) {
            ...
            $table->string('dr_certificado_movilizacion_t')->nullable();
            $table->boolean('dr_certificado_cumplimiento');
            $table->string('dr_certificado_cumplimiento_t')->nullable();
            $table->boolean('dr_cartilla_fitosanitaria');
            $table->string('dr_cartilla_fitosanitaria_t')->nullable();
            $table->boolean('dr_tarjeta_moscas');
            $table->string('dr_tarjeta_moscas_t')->nullable();
            $table->boolean('dr_copiacfmn');
            $table->string('dr_copiacfmn_t')->nullable();
            $table->boolean('dr_copia_certificado');
            $table->string('dr_copia_certificado_t')->nullable();
            $table->boolean('dr_diagnostico_fitosanitario');
            $table->string('dr_diagnostico_fitosanitario_t')->nullable();
            $table->boolean('dr_certificado_htlmf');
            $table->string('dr_certificado_htlmf_t')->nullable();
            $table->boolean('dr_tvaluacion_conformidad');
            $table->string('dr_tvaluacion_conformidad_t')->nullable();
            $table->boolean('dr_tratamiento_cuarentenario');
            $table->string('dr_tratamiento_cuarentenario_t')->nullable();
            $table->boolean('dr_ninguno');
            $table->boolean('dr_aviso');
            $table->string('dr_aviso_t')->nullable();
            $table->boolean('dr_otro')->nullable();
            $table->string('dr_otro_t')->nullable();
            ...
            $table->string('tv_otro_t')->nullable();
            ...
            $table->string('tm_otro_t')->nullable();
    ...
    {
        Schema::dropIfExists('op_embarques_rpv');
    }
};
