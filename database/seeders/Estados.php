...
class Estados extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $states = [
            ...
            [ 'nombre' => 'CHIHUAHUA', 'nombre_corto' => 'CHI', 'codigo' => '04', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'CHIAPAS', 'nombre_corto' => 'CHS', 'codigo' => '05', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'CAMPECHE', 'nombre_corto' => 'CMP', 'codigo' => '06', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'CIUDAD DE MEXICO', 'nombre_corto' => 'CMX', 'codigo' => '07', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'COAHUILA', 'nombre_corto' => 'COA', 'codigo' => '08', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'COLIMA', 'nombre_corto' => 'COL', 'codigo' => '09', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'DURANGO', 'nombre_corto' => 'DGO', 'codigo' => '10', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'GUERRERO', 'nombre_corto' => 'GRO', 'codigo' => '11', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'GUANAJUATO', 'nombre_corto' => 'GTO', 'codigo' => '12', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            ...
            [ 'nombre' => 'MICHOACAN', 'nombre_corto' => 'MCH', 'codigo' => '15', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'ESTADO DE MEXICO', 'nombre_corto' => 'MEX', 'codigo' => '16', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            ...
            [ 'nombre' => 'QUINTANA ROO', 'nombre_corto' => 'QR', 'codigo' => '22', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'QUERETARO', 'nombre_corto' => 'QRO', 'codigo' => '23', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'SINALOA', 'nombre_corto' => 'SIN', 'codigo' => '24', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'SAN LUIS POTOSI', 'nombre_corto' => 'SLP', 'codigo' => '25', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            ...
            [ 'nombre' => 'TLAXCALA', 'nombre_corto' => 'TLX', 'codigo' => '28', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            [ 'nombre' => 'TAMAULIPAS', 'nombre_corto' => 'TMS', 'codigo' => '29', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
