...
class Estados extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $states = [
            ...
            [ 'nombre' => 'CIUDAD DE MÉXICO', 'nombre_corto' => 'CMX', 'codigo' => '09', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
            ...
            [ 'nombre' => 'NUEVO LEÓN', 'nombre_corto' => 'NL', 'codigo' => '19', 'activo' => true, 'pais_id' => $country_id, 'created_at'=>now(), 'updated_at' => now() ],
