...
<body>
    <table>
        <tbody>
            <tr>
                <td id="ContentPlaceHolder1_ASPxFormLayout1_3_0">
                    <div>
                        <div id="template-container" class="watermark ">
                            <div class="section template-header">
                                ...
                                <h6 class="title">Dictamen de verificacion (DV) <br> para la movilizacion de productos vegetales</h6>
    ...
    <script>
        ...
        setTimeout(function() {
            ...
            document.body.innerHTML = '<h1>Impresión completada. Puede cerrar esta ventana.</h1>';
            };
            ...
            // Verificar si la impresión fue cancelada
            var checkPrintStatus = setInterval(function() {
            if (printAttempted && !window.matchMedia('print').matches) {
                clearInterval(checkPrintStatus);
                console.log('Impresión cancelada');
                document.body.innerHTML = '<h1>Impresión cancelada. Por favor, cierre esta ventana.</h1>';
            }
            }, 1000);
