...
@section('content')
    <div id="kt_content_container bg-light-primary" class="container-xxl">
        ...
        <div class="card table-responsive watermark py-6">
            <table class="dxflGroup_Moderno dxflGroupSys dxflAGSys" style="border-collapse:separate;">
                <tbody><tr>
                    <td id="ContentPlaceHolder1_ASPxFormLayout1_3_0" class="dxflHALSys dxflGroupCell_Moderno dxflChildInFirstRowSys dxflFirstChildInRowSys dxflLastChildInRowSys dxflLastChildSys dxflChildInLastRowSys"><div class="dxflNestedControlCell_Moderno dxflCLLSys dxflItemSys dxflTextItemSys dxflItem_Moderno">
                            ...
                            <div id="template-container">
                                ...
                                <div class="section">
                                    ...
                                    <div style="display: flex; align-items: center;">
                                        <div class="group-control" style="flex-grow: 1;">Dictamen de verificación: (<input id="IsDictamenVer" type="checkbox" name="IsDictamenVer" value="">)</div>
                                        <div class="group-control m-l-md" style="flex-grow: 1;">Certificado fitosanitario para la movilización nacional: (<input id="IsCFMN" type="checkbox" name="IsCFMN" value="">)</div>
                                        <div class="group-control m-l-md" style="flex-grow: 1;">Certificado fitosanitario internacional: (<input id="IsCFI" type="checkbox" name="IsCFI" value="">)</div>
                                    </div>
                                    <div class="m-t-xs" style="display: flex;">
                                        Otro(especifique):
                                        <input id="Otro1" class="m-l-sm" type="text" name="Otro1" value="" maxlength="250" style="flex-grow: 1;">
                                    </div>
                                </div>
                                <div class="section">
