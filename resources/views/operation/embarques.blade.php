    ...
    <div id="kt_content_container bg-light-primary" class="container-xxl">
        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="stepper_embarques">
                ...
                <div class="px-6 px-lg-10 px-xxl-15 py-20">
                    <div class="stepper-nav">
                        ...
                        <div class="stepper-item" data-kt-stepper-element="nav">
                            ...
                            <!--begin::Label-->
                            <div class="stepper-label">
                                <h3 class="stepper-title">Unidad de Verficación y TEF´s</h3>
            ...
            <div class="d-flex flex-row-fluid flex-center bg-body rounded">
                <form class="py-20 w-100 w-xl-700px px-9" novalidate="novalidate" id="form_embarques">
                        ...
                        <div class="">
                            ...
                            <div class="row mb-12">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input class="form-control form-control-solid" placeholder="Pick date rage" id="fecha_embarque" name="fecha_embarque"/>
                                </div>
                                <div class="col-md-6 fv-row">
                            ...
                            <div class="row mb-12">
                                ...
                                <div class="col-md-4 fv-row">
                                    <label class="required fs-6 fw-bold mb-2">N° Económico</label>
                                    <select id="localidad_id" name="localidad_id" class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_add_empaque" data-placeholder="Selecciona una localidad" data-allow-clear="true">
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="col-md-4 fv-row">
                                    <label class="required fs-6 fw-bold mb-2">Placas</label>
                                    <select id="localidad_id" name="localidad_id" class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_add_empaque" data-placeholder="Selecciona una localidad" data-allow-clear="true">
                                        <option value=""></option>
                                    </select>
                                </div>
