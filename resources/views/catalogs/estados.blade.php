                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_estado_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select id="pais_id" name="pais_id" class="form-select form-select-solid" data-control="select2" data-dropdown-parent="#kt_modal_add_estado" data-placeholder="Selecciona un categoría" data-allow-clear="true">
