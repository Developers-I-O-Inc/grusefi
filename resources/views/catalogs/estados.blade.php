...
@section('subtitle', 'Control de Estados')
@section('content')
                ...
                <div class="modal-content">
                    <form class="form" action="#" id="kt_modal_add_estado_form">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-2" id="kt_modal_add_estado_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-4">
                                    ...
                                    <input type="text" class="form-control d-none" name="id_estado" id="id_estado" />
                                </div>
                                <div class="fv-row mb-4">
                                ...
                                <div class="fv-row mb-4">
                                    ...
                                    <select id="pais_id" name="pais_id" class="form-select" data-control="select2" data-dropdown-parent="#kt_modal_add_estado" data-placeholder="Selecciona un País" data-allow-clear="true">
                                        <option></option>
