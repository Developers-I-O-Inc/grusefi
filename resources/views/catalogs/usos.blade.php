...
@section('title', 'Usos')
@section('title_top', 'Usos')
@section('config', 'active')
@section('subtitle_top', 'Control de usos')
@section('content')
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-uso-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Buscar usos" />
                    </div>
                </div>
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none"
                        ...
                        <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-uso-table-select="selected_count"></span>Seleccionados
                        </div>
                        <button type="button" class="btn btn-danger"
                            data-kt-uso-table-select="delete_selected">Borrar Seleccionados</button>
                    </div>
                </div>
            </div>
            <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_usos_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                        data-kt-check-target="#kt_usos_table .form-check-input" value="1" />
                                </div>
                            </th>
                            <th class="min-w-125px">id</th>
                            <th class="min-w-125px">uso</th>
                ...
                <div class="modal-content">
                    <form class="form" action="#" id="kt_modal_add_uso_form">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_uso_scroll" data-kt-scroll="true"
                        ...
                        <div class="modal-footer flex-center">
                            <button type="button" id="kt_modal_add_uso_cancel"
                                class="btn btn-light me-3">Cancelar</button>
                            <button type="submit" id="kt_modal_add_uso_submit" class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{asset('assets/js/catalogs/usos.js')}}" type="module"></script>
@endpush
